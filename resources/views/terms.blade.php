...
<div class="container">
	<div class="row">
	    <div class="col-md-10 col-md-offset-1 terms">
			...
			This Terms of Use is applicable to Friendz Square and by accessing Friendz Square you consent to accept the following terms as specified below. Furthermore, by accepting these Terms of Use, you also agree to be bound by the Friendz Square’s Privacy Policy. <br>

			<ol>
				<li>Friendz Square as a platform <br>
					<ul>
						<li>By using Friendz Square through a website www.friendzsquare.com &amp;/or application on any

						internet enabled device, its deemed to be considered that you understand that Friendz

						Square is merely platform that facilitates communication between users on Friendz Square

						and any interaction between users is solely between them and Friendz Square don't take

						any part in that.
						</li>
						<li>
						Friendz Square a mere platform for users to connect with other users and we have no active

						role in any subsequent communication. </li>
						<li>
						For all the information you share on Friendz Square, we will consider it our non-exclusive,
				...
				<li> No Liability on Friendz Square <br>
					<ul>
						...
						<li>
							By accepting these Terms of Use, you agree not to hold Friendz Square responsible or
				...
				<li> You have sole right to the information you share on Friendz Square <br>
					<br>

					You hereby agree that you have the sole rights and title to the information that you provide and that hence is solely responsible and accountable for posting the information and that Friendz Square is just platform to make your information public online.
				</li>
				...
				<li> Your conduct: <br><br>
					...
					You take the responsibility of your posts while using the Friendz Square and any subsequent

					consequences due to your use of Friendz Square. While posting on forums or chatting with other
					...
					<ul>
						...
						that may harm Friendz Square or its users.</li>
						...
						<li>Submit content that falsely expresses or implies that such content is sponsored or endorsed by Friendz Square;

						While Friendz Square prohibits such conduct and posts, you understand and agree that you

						nonetheless may be exposed to such conduct and/or posts and that you use Friendz Square at your own risk.</li>
					</ul>
				</li>
				...
				<li> Friendz Square is available worldwide <br><br>

					Friendz Square website &amp;/or application is available worldwide for users of any age.
				</li>
				<li> Website links <br><br>

					Friendz Square may have its users posting links of other websites. If the user views these links it will

					be at sole risk of the user and it will be user’s responsibility to take all protective measures to

					safeguard themselves against any viruses they may encounter by visiting those websites. Friendz Square don’t endorse any website.
				</li>
				<li> Intellectual property rights <br><br>

					Connect All Pte Ltd. is the sole owner or lawful licensee of all the rights to Friendz Square. By accepting the terms users agree that that they will not copy any information, structure database etc. of Friendz Square.
				</li>
				...
				<li> Amendment to Terms of Use <br><br>
					...
					Friendz Square may amend this Terms of Use anytime without any intimation and the amended Terms of Use will be effective immediately on posting. If you continue to use the service then it will be deemed as your acceptance to the changed terms. Hence, if you do not agree to the changes to the Terms of Use, then stop using the service.
				</li>
			</ol>
	    </div>
  	</div>
