                        ...
                        var l = {
                            ...
                            d = function(t, o) {
                                ...
                                if (n !== !1) {
                                    var r = void 0,
                                        s = void 0;
                                    t.top ? (l.top = 0, r = o.top) : (l.bottom = 0, r = -o.bottom), t.left ? (l.left = 0, s = o.left) : (l.right = 0, s = -o.right);
                                    
                                    if( 200 > o.left && o.left > 100 ) {
                                    	s = 300;
                                    } else if( 100 > o.left ) {
                                    	s = 100;
                                    }
                                    if( 30 > o.right && o.right > 0 ) {
                                        s -= 30;
                                    }
                                    if( 0 > o.right ) {
                                        s -= 70;
                                    }
                                    if( 120 > o.right && 30 < o.right ) {
                                        s -= 2 * Math.abs(Math.round(o.right));
                                    }
                                    if( 150 > o.right && o.left < 250 ) {
                                    	s = 150;
                                    }

                                    if( 250 > o.bottom && o.top > 250 ){
                                    	r -= 245; 
                                    }
                                    l[k] = "translateX(" + Math.round(s) + "px) translateY(" + Math.round(r) + "px)", "msTransform" !== k && (l[k] += " translateZ(0)")
